...
<body>
    <form id="form1" runat="server">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAgregarCategoria">Agregar Categoría</button>
            </div>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%# Eval("NombreCategoria") %></td>
                     <td>
                             <!-- Botón para editar -->
                      <a href='<%# "EditarCategorias.aspx?id=" + Eval("ID") %>' class="btn btn-warning">Editar</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" id="txtNombreCategoria" runat="server" placeholder="Nombre de la Categoría" class="form-control" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
