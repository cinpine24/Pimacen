...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="titulo">
                <h2>Unidades de Productos</h2>
                <br />
                <br />
        <!-- Botón para abrir el modal de agregar categoría -->
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAgregarCategoria">Agregar Unidad</button>
            </div>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%# Eval("Tipo") %></td>
                     <td>
                             <!-- Botón para editar -->
                      <a href='<%# "EditarUnidades.aspx?id=" + Eval("ID") %>' class="btn btn-warning">Editar</a>
        ...
        <div class="modal fade" id="modalAgregarCategoria" tabindex="-1" aria-labelledby="modalAgregarCategoriaLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalAgregarCategoriaLabel">Agregar Nueva Unidad</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!-- Campo del formulario para el nombre de la categoría -->
                        <input type="text" id="txtNombreCategoria" runat="server" placeholder="Nombre de la Unidad" class="form-control" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <asp:Button ID="btnGuardarCategoria" runat="server" Text="Guardar Categoría" CssClass="btn btn-primary" OnClick="btnGuardarCategoria_Click" />
                    </div>
                </div>
            </div>
        </div>
